...
variable "create_avd_resource_group" {
  description = "Create a resource group for the AVD Workspace. If set to false, the existing_resource_group_name variable must be set. Default is false."
  type        = bool
  default     = false
}
