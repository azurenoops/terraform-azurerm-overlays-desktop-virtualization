...
locals {
  aad_group_list = var.avd_application_config != null ? distinct(values({ for k, v in var.avd_application_config : k => v.aad_group })) : distinct(values({ for k, v in var.avd_vm_config : k => v.aad_group_desktop }))
